...
来源角色随当前任务解释：人生的direction是本人方向与取舍；商业是当前业务目标与经营约束；职业是岗位任务用途、验收与本人已表达的成长诉求。current分别对应生活事项、经营项目或工作任务的最新决定与反馈。后两者不因共用角色名而读取个人全人生档案。

同一根目录多项目时，common只放当前确实共用的约束；不同主体或项目的事实绑定到各自routes，主控明确选择本次项目的类型与原件。不要把所有公司的数据放进共同必读集，或把文件名相近当成同一事实。新模板只提供候选入口，需按实际项目细化后再读取。
