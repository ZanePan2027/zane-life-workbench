...
一个从眼前问题开始的 AI 人生工作台。帮助你理解处境、推演未来方向、作出取舍、协调时间与责任、完成具体事情，并在现实变化后继续。怎样过好，由你自己定义。
...
| 根据我的目标和目前变化，未来可能往哪走？现在怎么准备？ | 少数有依据的走向、条件选择、提前准备和改选信号 |
| 工作、陪家人和学习都想安排，这周放得下吗？ | 一周安排、冲突位置与需要调整或协商的事 |
| 想搬家，但不知道从哪里开始 | 按当前条件拆出的准备事项和下一步 |
| 我总在几种选择之间反复，想理解自己在意什么 | 根据具体经历形成的暂定认识和可以尝试的做法 |
| 最近有点难受，先听我说说，不急着给建议 | 具体的倾听与共同理解；愿意时再探索或尝试改变 |
| 上次的条件变了，这件事要怎么继续？ | 重算相关判断，更新成果与暂停点 |

比较选择时，先给主建议和成立条件，再说明关键取舍、当前动作和改选信号。你可以直接说“简短一点，让我看懂怎么选”，也可以要求展开完整分析。

心理支持也可以直接开始，不必先建台或做量表。它可辅助倾诉、自我理解和咨询准备；不作诊断，不替代专业治疗。敏感笔记按明确授权保存，平台聊天留存另依所用服务的设置。
...
日常继续使用 `zane-workbench`。熟悉后，可以直接选择问题澄清、自我认识、心理支持、AI伙伴设定或工作台整理等方法；[能力目录](docs/skill-inventory.md)列出适用场景、输入示例和产出。

## 版本与反馈

当前为 **1.0 正式版**，本次修订日期为 **2026-09-19**。[更新记录](CHANGELOG.md) · [版本检查记录](docs/testing.md)。
